...
/// Hint for the commented-out `requires.min-version` in configs generated by
/// `vk dev init`; inert until uncommented. Uses the running release because a
/// generated config is only guaranteed to run on the vk release that wrote it.
pub const MIN_VERSION: &str = env!("CARGO_PKG_VERSION");
