...
//!
//! [`crate::term`] handles terminal detection, the alternate screen, signal restoration
//! and decoding keyboard bytes.
//!
...
use crate::term::{
    AltScreen, Press, bar, catch_terminating_signals, clip, current_termios, key_thread,
};
