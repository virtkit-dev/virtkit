...
//! terminating ones are caught long enough to restore it and then re-raised.
//!
...
/// The terminal settings a signal handler puts back on stdin. Read once before raw mode is
